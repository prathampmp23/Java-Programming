...
public class LongestCommonSubsequence {
    ...
    public static void main(String[] args) {
        String str1 = "abcde";
        String str2 = "ace";
        System.out.println("LCS length using recursion = " + lcsRec(str1, str2, str1.length(), str2.length()));
        ...
        System.out.println("LCS length using memoization = " + lcsMemo(str1, str2, n, m, dp));
